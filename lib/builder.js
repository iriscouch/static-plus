...
Builder.prototype.doc = function(doc, source) {
  ...
  self.prep_template(function(er) {
    ...
    self.add(doc._id, content, DEFS.page_type, source)
  })
}
...
Builder.prototype.page = function(id, content) {
  ...
  return self.add(id, content, DEFS.page_type)
}


Builder.prototype.add = function(id, content, type, source) {
  var self = this

  if(typeof id != 'string')
    throw new Error('Must supply a string id')
  if(typeof content != 'string' && !(content instanceof Buffer))
    throw new Error('Must supply a string or Buffer page content')
  if(!type || typeof type != 'string')
    throw new Error('Must supply a string for content type')
